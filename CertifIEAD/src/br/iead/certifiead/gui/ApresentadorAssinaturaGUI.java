 ...
 */
public class ApresentadorAssinaturaGUI extends javax.swing.JDialog {

    /**
     * Creates new form ApresentadorGUI
     */
    public ApresentadorAssinaturaGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApresentadorAssinaturaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ApresentadorAssinaturaGUI dialog = new ApresentadorAssinaturaGUI(new javax.swing.JFrame(), true);
